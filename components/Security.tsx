...
const securityFeatures = [
  {
    ...
    description:
      "Hochauflösende Kameras überwachen das gesamte Gelände rund um die Uhr",
  },
  {
    icon: Lock,
    title: "Elektronische Zugangskontrolle",
    description:
      "Jeder Kunde erhält einen individuellen Zugangscode für maximale Sicherheit",
  },
  {
    icon: Shield,
    title: "Versicherungsschutz",
    description:
      "Optionale Versicherung für Ihre gelagerten Gegenstände verfügbar",
  },
];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mt-12">
          <p className="text-lg text-gray-300 mb-6">
            Zusätzlich empfehlen wir jedem Kunden, eine Hausratversicherung
            abzuschließen oder zu prüfen, ob die bestehende Versicherung auch
            Gegenstände in Lagerboxen abdeckt.
          </p>
